...
class VectorQuantizer2(nn.Module):
    ...
    def __init__(self, n_e, e_dim, beta, remap=None, unknown_index="random",
        ...
        self.embedding = nn.Embedding(self.n_e, self.e_dim)
        # Use 1/sqrt(e_dim) initialization for better gradient flow
        # For e_dim=1, this gives [-1, 1] instead of [-1/16384, 1/16384]
        self.embedding.weight.data.uniform_(-1.0 / max(1.0, e_dim), 1.0 / max(1.0, e_dim))
